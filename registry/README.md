...
- 裸机业务服务统一接入 [agent](file:///Users/lhdht/product/firefly/go-micro/registry/agent)
...
| `go-micro/registry/agent` | 裸机 sidecar-agent 正式接入库 |

## 后续迁移

- 面向业务服务的新接入，一律走 `registry/agent`
